...
int main() {
	assert(testFind_Success());
	assert(testFind_Failure());

	assert(testContains_Exists());
	assert(testContains_Missing());

	assert(testContainsOfType_TypeMatches());
	assert(testContainsOfType_TypeMismatch());
	assert(testContainsOfType_Missing());

	assert(testGetBoolValue_TypeMatches());
	assert(testGetBoolValue_TypeMismatch());
	assert(testGetBoolValue_Missing());

	assert(testGetIntValue_TypeMatches_Int());
	assert(testGetIntValue_TypeMatches_Object());
	assert(testGetIntValue_TypeMismatch());
	assert(testGetIntValue_Missing());

	assert(testGetDecimalValue_TypeMatches());
	assert(testGetDecimalValue_TypeMismatch());
	assert(testGetDecimalValue_Missing());

	assert(testGetStringValue_TypeMatches_String());
	assert(testGetStringValue_TypeMatches_Color());
	assert(testGetStringValue_TypeMatches_File());
	assert(testGetStringValue_TypeMismatch());
	assert(testGetStringValue_Missing());
