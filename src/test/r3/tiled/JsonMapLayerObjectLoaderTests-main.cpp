...
int main() {
	assert(testValidate_Valid_Rectangle());
	assert(testValidate_Valid_Point());
	assert(testValidate_Valid_Ellipse());
	assert(testValidate_Valid_Polyline());
	assert(testValidate_Valid_Polygon());
	assert(testValidate_Valid_Tile());

	assert(testValidate_InvalidRoot());

	assert(testValidate_MissingId());
	assert(testValidate_Id(1, true));
	assert(testValidate_Id(0, false));
	assert(testValidate_Id("wut", false));

	assert(testValidate_MissingX());
	assert(testValidate_X(1, true));
	assert(testValidate_X(1.5, true));
	assert(testValidate_X("nope", false));

	assert(testValidate_MissingY());
	assert(testValidate_Y(-1, true));
	assert(testValidate_Y(-1.5, true));
	assert(testValidate_Y("um", false));

	assert(testValidate_MissingRotation());
	assert(testValidate_Rotation(50, true));
	assert(testValidate_Rotation(50.5, true));
	assert(testValidate_Rotation("not a chance", false));

	assert(testValidate_MissingWidth());
	assert(testValidate_Width(false, 1.5, true));
	assert(testValidate_Width(true, 0, true));
	assert(testValidate_Width(false, 0, false));
	assert(testValidate_Width(false, -2, false));
	assert(testValidate_Width(false, "ugh", false));

	assert(testValidate_MissingHeight());
	assert(testValidate_Height(false, 100.5, true));
	assert(testValidate_Height(true, 0, true));
	assert(testValidate_Height(false, 0, false));
	assert(testValidate_Height(false, -1, false));
	assert(testValidate_Height(false, "no way", false));

	assert(testValidate_InvalidObjectType_Point());
	assert(testValidate_InvalidObjectType_Ellipse());
	assert(testValidate_InvalidObjectType_Polyline());
	assert(testValidate_InvalidObjectType_Polygon());
	assert(testValidate_InvalidObjectType_Tile());

	assert(testValidate_TileGid(1, true));
	assert(testValidate_TileGid(0, false));
	assert(testValidate_TileGid("nuh uh", false));

	assert(testValidate_InvalidPolylinePointList());
	assert(testValidate_InvalidPolygonPointList());

	assert(testValidate_MissingName());
	assert(testValidate_Name("The Thing", true));
	assert(testValidate_Name("", true));
	assert(testValidate_Name(1, false));

	assert(testValidate_MissingType());
	assert(testValidate_Type("Goblin", true));
	assert(testValidate_Type("", true));
	assert(testValidate_Type(2, false));

	assert(testValidate_InvalidPropertyList());

	assert(testLocalizeObjectListError());
	...
	assert(testLocalizeValidationResult_RotationInvalid());
	assert(testLocalizeValidationResult_WidthInvalid());
	assert(testLocalizeValidationResult_HeightInvalid());
	assert(testLocalizeValidationResult_ObjectTypeInvalid());
	assert(testLocalizeValidationResult_TileGidInvalid());
	assert(testLocalizeValidationResult_PointListInvalid_Polyline());
	assert(testLocalizeValidationResult_PointListInvalid_Polygon());
	...
	assert(testConvertToDefn_Rectangle());
	assert(testConvertToDefn_Point());
	assert(testConvertToDefn_Ellipse());
	assert(testConvertToDefn_Polyline());
	assert(testConvertToDefn_Polygon());
	assert(testConvertToDefn_Tile());
